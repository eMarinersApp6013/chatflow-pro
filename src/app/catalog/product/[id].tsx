  ...
  return (
    <View style={s.container}>
      <View style={s.header}>
        ...
        <Text style={s.headerTitle}>Product #{id}</Text>
      </View>
      <View style={s.content}><Text style={s.msg}>Product detail with bundle suggestions coming in Phase 5.</Text></View>
    </View>
  );
}
